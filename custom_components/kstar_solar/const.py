...
SENSOR_TYPES = {
    ...
    "dayEarn": {"name": "日收益", "unit": "元", "icon": "mdi:currency-cny", "device_class": "monetary"},
    "totalEarn": {"name": "总收益", "unit": "元", "icon": "mdi:currency-cny", "device_class": "monetary"},
    "co2": {"name": "CO2减排量", "unit": "kg", "icon": "mdi:molecule-co2", "device_class": "weight"},
    "coal": {"name": "节煤量", "unit": "kg", "icon": "mdi:fire", "device_class": "weight"},
    "forest": {"name": "森林面积", "unit": "m²", "icon": "mdi:tree", "device_class": "area"},
} 